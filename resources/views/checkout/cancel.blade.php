    ...
    <div class="max-w-3xl mx-auto px-4 py-6">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('dashboard') }}" class="px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200">
                    Return to Home
                </a>
                <a href="{{ route('cart.view') }}" class="px-6 py-3 bg-slate-900 text-white font-medium rounded-lg text-white hover:bg-slate-800 transition-colors duration-200">
                    Return to Cart
                </a>
            </div>
        </div>
